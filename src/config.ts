...
export const profileConfig: ProfileConfig = {
	...
	umami: {
		...
		shareId: "icocgaX4MW4gFonX", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
...
export const announcementConfig: AnnouncementConfig = {
	title: "本站特色", // 公告标题
	content: "本网站使用 Astro 框架构建，并采用了 Mizuki 主题。", // 公告内容
